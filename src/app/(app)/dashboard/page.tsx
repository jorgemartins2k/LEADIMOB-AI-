                        ...
                        <div className="space-y-4 sm:space-y-6">
                            {[
                                ...
                                <Link key={i} href="/agenda" className="flex items-center gap-4 sm:gap-5 p-5 sm:p-6 rounded-[24px] sm:rounded-[32px] bg-muted/5 border border-border/30 hover:bg-muted/10 transition-all cursor-pointer group shadow-sm hover:shadow-md min-h-[80px]">
                                    <div className={cn(
                                        "h-12 w-12 sm:h-14 sm:w-14 rounded-xl sm:rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform shadow-inner shrink-0",
                                    ...
                                    <div className="flex flex-col min-w-0">
                                        ...
                                        <span className="text-[9px] sm:text-[10px] md:text-xs font-bold text-muted-foreground uppercase tracking-widest mt-1">{item.time} • {item.client}</span>
                                    </div>
                                </Link>
                            ))}
                        </div>
