...
export default async function PropertyDetailsPage({ params }: PropertyDetailsPageProps) {
    try {
        ...
        return (
            <div className="p-10 card-premium bg-destructive/10 border-destructive/50">
                <h1 className="text-xl font-bold text-destructive mb-4">Debug Error Dashboard</h1>
                <p className="text-sm font-mono bg-black/50 p-4 rounded-lg overflow-auto">
